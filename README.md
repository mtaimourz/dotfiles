...
the relevant configuration file and are detected at runtime; there are no
duplicated `mac/` and `ubuntu/` trees.
...
See `AGENTS.md` before changing or deploying configuration.
